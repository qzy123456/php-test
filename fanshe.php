...
$properties = $reflector_class->getProperties();//获取对象所有的属性方法，（比如上面的ReflectorTest::class中的 private $refletorProperty1这种）
$constructor = $reflector_class->getConstructor();//获取类的构造函数，不存在时返回null
$constructor_parameters = $constructor->getParameters();//获取构造函数的值
//构造函数对应4个参数，
//$request = 10,  $response, ConstructorParameter $constructorParameter, Closure $closure
